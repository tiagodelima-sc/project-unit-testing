...
public class Main {
	...
	static GerenciaCliente gerClientes;
	static GerenciaConta gerContas;
	
	public static void main(String[] args) {
		
		inicializaSistemaBancario(); // inicializando algumas contas e clientes fictícios
	...
	/**
	 * Cria e add algumas contas e clientes no sistema do banco,
	...
	private static void inicializaSistemaBancario() {
		...
		Cliente cliente01 = new Cliente(1, 20, conta01.getId(), "Tiago de lima", "tiago.l07@aluno.ifsc.edu", false);
		Cliente cliente02 = new Cliente(2, 21, conta02.getId(), "Mateus Rodrigues", "mateus@gmail.com", true);
		// inserindo os clientes criados na lista de clientes do banco
		clientesDoBanco.add(cliente01);
		clientesDoBanco.add(cliente02);
		
		gerClientes = new GerenciaCliente(clientesDoBanco);
		gerContas = new GerenciaConta(contasDoBanco);
